package com.rzspider.project.book.bookmanage.domain;

import com.rzspider.framework.web.domain.BaseEntity;
import java.util.Date;

/**
 * 图书详情表 book_bookmanage
 * 
 * @author ricozhou
 * @date 2018-05-28
 */
public class Bookmanage extends BaseEntity
{
	...
	/** 图书购买价 */
	private String bookPurchasePrice;
	/** 图书出版日期 */
	...
	/** 图书所在地 */
	private String bookStayAddress;
	/** 阅读状态 */
	private Integer bookReadStatus;
	/** 阅读星级 */
	private Integer bookReadStar;
	/** 阅读评价 */
	private String bookReadEvaluation;
	/** 用户ID */
	 ...
	 * 设置：图书购买价
	 */
	public void setBookPurchasePrice(String bookPurchasePrice) 
	{
	 ...
	 * 获取：图书购买价
	 */
	public String getBookPurchasePrice() 
	{
	 ...
	 * 设置：图书所在地
	 */
	public void setBookStayAddress(String bookStayAddress) 
	{
		this.bookStayAddress = bookStayAddress;
	}
	
	/**
	 * 获取：图书所在地
	 */
	public String getBookStayAddress() 
	{
		return bookStayAddress;
	}
	
	/**
	 * 设置：阅读状态
	 */
	public void setBookReadStatus(Integer bookReadStatus) 
	{
	 ...
	 * 获取：阅读状态
	 */
	public Integer getBookReadStatus() 
	{
	 ...
	 * 设置：阅读评价
	 */
	public void setBookReadEvaluation(String bookReadEvaluation) 
	{
		this.bookReadEvaluation = bookReadEvaluation;
	}
	
	/**
	 * 获取：阅读评价
	 */
	public String getBookReadEvaluation() 
	{
		return bookReadEvaluation;
	}
	...
	public String toString() {
		return "Bookmanage [bookId=" + bookId + ", bookName=" + bookName + ", bookAuthor=" + bookAuthor
				+ ", bookPublisher=" + bookPublisher + ", bookIsbn=" + bookIsbn + ", bookDes=" + bookDes
				+ ", bookLanguage=" + bookLanguage + ", bookOriginalPrice=" + bookOriginalPrice + ", bookPurchasePrice="
				+ bookPurchasePrice + ", bookPublishTime=" + bookPublishTime + ", bookClassification="
				+ bookClassification + ", bookBinding=" + bookBinding + ", bookPages=" + bookPages
				+ ", bookStayAddress=" + bookStayAddress + ", bookReadStatus=" + bookReadStatus + ", bookReadStar="
				+ bookReadStar + ", bookReadEvaluation=" + bookReadEvaluation + ", userId=" + userId + ", status="
