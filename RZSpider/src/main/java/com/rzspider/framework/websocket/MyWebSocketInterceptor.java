...
public class MyWebSocketInterceptor implements HandshakeInterceptor {
	...
	public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler,
		...
		if (request instanceof ServletServerHttpRequest) {
			String customSpiderBackId = ((ServletServerHttpRequest) request).getServletRequest()
					.getParameter(WebSocketConstants.WEBSOCKET_PARAMS_CSID);
			attributes.put(WebSocketConstants.WEBSOCKET_PARAMS_CSID, customSpiderBackId);
		}
		return true;
	}
