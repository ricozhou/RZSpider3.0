package com.rzspider.framework.aspectj;
...
import com.rzspider.project.monitor.operlog.service.IOperLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.rzspider.framework.aspectj.lang.annotation.Log)")
